    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if(email!=null && cpass.equals(pass))
                {
                            ...
                            if (task.isSuccessful()){
                                ...
                                reference.child("userinfo").addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        reference.child("userinfo").child(uid).child("Company").setValue("Null");
                                        reference.child("userinfo").child(uid).child("CompanyStartFrom").setValue("Null");
                                        reference.child("userinfo").child(uid).child("About").setValue("(Edit to add)");
                                        reference.child("userinfo").child(uid).child("Experience").child("Exp1").setValue("Null");
                                        reference.child("userinfo").child(uid).child("Experience").child("Exp2").setValue("Null");
                                        reference.child("userinfo").child(uid).child("Education").child("School").setValue("school");
                                        reference.child("userinfo").child(uid).child("Education").child("SchoolYear").setValue("schoolyear");
                                        reference.child("userinfo").child(uid).child("Education").child("College").setValue("college");
                                        reference.child("userinfo").child(uid).child("Education").child("CollegeYear").setValue("collegeyear");
